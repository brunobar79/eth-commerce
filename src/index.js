...
class EthCommerce {
	...
	static render(domTarget, amount, address, defaultStyles=true){
		  ...
		  if (typeof web3 !== 'undefined') {
		    ...
		    // Use the browser's ethereum provider
		  	provider.eth.getAccounts(function(err, accounts) { 
		  	   EthCommerce.renderButton(accounts[0], domTarget, amount, address, defaultStyles=true);
		    });
	...
	static renderQR(){
		...
		//You can scan this code using a mobile wallet
		//and send a payment of XX to it
		console.log('should render QR');
		//Once you do it, enter your address
		//or let us scan it so we can validate the transaction
	}


	static renderButton(account, domTarget, amount, address, defaultStyles=true){
		...
		img.src= EthCommerce.getImage('ETHEREUM_ICON');
		img.id = 'eth-icon-svg';
		...
		document.getElementById(domTarget).appendChild(a);
